...
public class PhoneCreditCardFrame extends JFrame implements ActionListener{
	...
	private JTextField getShippingAddress;
	...
	public PhoneCreditCardFrame(orders newOrder) {
		...
		this.getShippingAddress = new JTextField();
		getShippingAddress.setBounds(40, 360, 500, 20);
		p.add(getShippingAddress);
		
		btn1 = new Button("Place Order");
		btn1.addActionListener(this);
		btn1.setBounds(190,400,200,40);
		p.add(btn1);
	...
	public void actionPerformed(ActionEvent e){
		...
		String newAddress = getShippingAddress.getText();
		...
		newOrder.setShippingAddress(newAddress);
