...
public class EditUsersFrame extends JPanel {

	String shoppingCart = "";
	private String movieTitle, userToRemove;
	List<String> shoppingList;
	List<movie> shoppingList2;
	shoppingCart newCart;

	public EditUsersFrame() throws Exception {
		...
		for (User u: maintain.users) {
			if(!u.getAccountType().equals(AccountType.Admin)) {
				count++;
			}
		}
